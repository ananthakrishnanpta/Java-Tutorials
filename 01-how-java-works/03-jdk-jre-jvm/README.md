...
This lesson develops practical understanding of **JDK JRE JVM**. Start by observing the behavior in small programs, then connect that behavior to the API contract, performance, and common failure modes.

By the end of this lesson, you should be able to:

- explain **JDK JRE JVM** without relying on jargon;
...
Open the [`examples/`](examples/) directory, compile one program, then modify it to test an edge case. Write down two questions you would ask in a code review about this topic. Sketch a diagram that connects the code-level model to its runtime behavior.
