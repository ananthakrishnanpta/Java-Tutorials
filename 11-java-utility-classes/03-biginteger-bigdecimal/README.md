...
> Part: [Java Utility Classes](../README.md)

## Outcome

This lesson develops practical understanding of **BigInteger BigDecimal**. Start by observing the behavior in small programs, then connect that behavior to the API contract, performance, and common failure modes.

By the end of this lesson, you should be able to:

- explain **BigInteger BigDecimal** without relying on jargon;
