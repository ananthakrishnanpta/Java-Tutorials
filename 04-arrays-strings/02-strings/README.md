...
> Part: [Arrays Strings](../README.md)

## Outcome

This lesson develops practical understanding of **Strings**. Start by observing the behavior in small programs, then connect that behavior to the API contract, performance, and common failure modes.

By the end of this lesson, you should be able to:

- explain **Strings** without relying on jargon;
...
Open the [`examples/`](examples/) directory, compile one program, then modify it to test an edge case. Create one small challenge in [`exercises/`](exercises/) and solve it without copying an answer. Sketch a diagram that connects the code-level model to its runtime behavior.
