...
> Part: [JVM Deep Dive](../README.md)

## Outcome

This lesson develops practical understanding of **Garbage Collector Internals**. Start by observing the behavior in small programs, then connect that behavior to the API contract, performance, and common failure modes.

By the end of this lesson, you should be able to:

- explain **Garbage Collector Internals** without relying on jargon;
...
Use [`examples/`](examples/) as your workspace: write a ten-line program that demonstrates one rule, then modify it to test an edge case. Write down two questions you would ask in a code review about this topic. Sketch a diagram that connects the code-level model to its runtime behavior.
