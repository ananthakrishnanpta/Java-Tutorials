...
This lesson develops practical understanding of **Optional**. Start by observing the behavior in small programs, then connect that behavior to the API contract, performance, and common failure modes.

By the end of this lesson, you should be able to:

- explain **Optional** without relying on jargon;
